...
ifeq ($(REDIS_DIR),redis-6.2.18)

  LOCAL_SRC_FILES += \
    $(SRC)/acl.c $(SRC)/adlist.c $(SRC)/ae.c \
    $(SRC)/anet.c $(SRC)/aof.c $(SRC)/bio.c \
    $(SRC)/bitops.c $(SRC)/blocked.c $(SRC)/childinfo.c \
    $(SRC)/cluster.c $(SRC)/connection.c \
    $(SRC)/config.c $(SRC)/crc16.c $(SRC)/crc64.c $(SRC)/crcspeed.c \
    ...
    $(SRC)/gopher.c $(SRC)/hyperloglog.c $(SRC)/intset.c $(SRC)/latency.c \
    $(SRC)/lazyfree.c $(SRC)/listpack.c $(SRC)/localtime.c $(SRC)/lolwut.c \
    $(SRC)/lolwut5.c $(SRC)/lolwut6.c \
    $(SRC)/lzf_c.c $(SRC)/lzf_d.c  $(SRC)/memtest.c \
    $(SRC)/module.c $(SRC)/monotonic.c $(SRC)/mt19937-64.c \
    $(SRC)/multi.c $(SRC)/networking.c $(SRC)/notify.c \
    ...
    $(SRC)/server.c $(SRC)/setproctitle.c $(SRC)/sha1.c $(SRC)/sha256.c \
    $(SRC)/siphash.c $(SRC)/slowlog.c $(SRC)/sort.c $(SRC)/sparkline.c \
    $(SRC)/syncio.c $(SRC)/tracking.c $(SRC)/timeout.c $(SRC)/t_hash.c $(SRC)/t_list.c \
    $(SRC)/t_set.c $(SRC)/t_stream.c $(SRC)/t_string.c $(SRC)/t_zset.c \
    $(SRC)/tls.c $(SRC)/util.c $(SRC)/wait3.c $(SRC)/ziplist.c \
...
REDIS_ANDROID_DIR := redis-6.2.18
REDIS_DIR := redis-6.2.18
...
ifeq ($(REDIS_DIR),redis-6.2.18)
  ...
  LOCAL_SRC_FILES += \
    ...
    $(SRC)/expire.c $(SRC)/geo.c $(SRC)/geohash.c $(SRC)/geohash_helper.c \
    $(SRC)/gopher.c $(SRC)/hyperloglog.c $(SRC)/intset.c $(SRC)/latency.c \
    $(SRC)/lazyfree.c $(SRC)/lolwut.c $(SRC)/lzf_c.c $(SRC)/lzf_d.c  $(SRC)/memtest.c \
    $(SRC)/module.c $(SRC)/monotonic.c $(SRC)/mt19937-64.c \
    $(SRC)/multi.c $(SRC)/networking.c $(SRC)/notify.c \
    $(SRC)/object.c $(SRC)/pqsort.c $(SRC)/pubsub.c \
    $(SRC)/quicklist.c $(SRC)/rand.c $(SRC)/rax.c $(SRC)/rdb.c \
    ...
    $(SRC)/siphash.c $(SRC)/slowlog.c $(SRC)/sort.c $(SRC)/sparkline.c \
    $(SRC)/syncio.c $(SRC)/tracking.c $(SRC)/timeout.c $(SRC)/t_hash.c $(SRC)/t_list.c \
    $(SRC)/t_set.c $(SRC)/t_string.c $(SRC)/t_zset.c $(SRC)/tls.c \
...
ifeq ($(REDIS_DIR),redis-6.2.18)
  ...
  LOCAL_SRC_FILES += \
    ...
    $(SRC)/server.c $(SRC)/setproctitle.c $(SRC)/sha1.c $(SRC)/sha256.c \
    $(SRC)/siphash.c $(SRC)/slowlog.c $(SRC)/sort.c $(SRC)/sparkline.c \
    $(SRC)/syncio.c $(SRC)/tracking.c $(SRC)/t_hash.c $(SRC)/t_list.c \
    $(SRC)/t_set.c $(SRC)/t_string.c $(SRC)/t_zset.c \
    $(SRC)/lolwut.c $(SRC)/lolwut5.c $(SRC)/lolwut6.c $(SRC)/localtime.c \
    $(SRC)/listpack.c $(SRC)/t_stream.c $(SRC)/timeout.c $(SRC)/tls.c \
    $(SRC)/util.c $(SRC)/wait3.c $(SRC)/ziplist.c \
    $(SRC)/zipmap.c $(SRC)/zmalloc.c $(SRC)/redis-check-aof.c \
    $(SRC)/redis-check-rdb.c
...
LOCAL_SRC_FILES += \
  ...
  $(SRC)/release.c $(SRC)/crc64.c $(SRC)/crcspeed.c \
